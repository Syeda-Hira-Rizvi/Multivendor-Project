...
export const getAllOrdersOfUser = (userId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${process.env.REACT_APP_BASE_URL}/order/get-all-orders/${userId}`);
...
export const getAllOrdersOfShop = (shopId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_BASE_URL}/order/get-seller-all-orders/${shopId}`
    );
...
export const getAllOrdersOfAdmin = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${process.env.REACT_APP_BASE_URL}/order/admin-all-orders`, {
      withCredentials: true,
    });
