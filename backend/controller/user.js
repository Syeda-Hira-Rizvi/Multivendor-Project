...
router.post("/create-user", async (req, res, next) => {
  try {
    ...
    const activationUrl = `https://multivendor-project-frontend.vercel.app/activation/${activationToken}`;
  ...
  catchAsyncErrors(async (req, res, next) => {
    try {
      ...
      // )}/reset-password/${resetToken}`;
       const resetUrl =`https://multivendor-project-frontend.vercel.app/reset-password/${resetToken}`;
